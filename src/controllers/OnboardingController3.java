...
public class OnboardingController3 extends TransitionUtils implements Initializable{
	@FXML private Button next3= new Button();
	...
	{
		next3.setStyle("-fx-background-color: #fff");
	}
	...
	public void initialize(URL location, ResourceBundle resources) {
	     ...
	     next3.setOnAction((e)->
	     {
	    	fadeOutToScene(vb3, "OnboardingScreen4"); 
	     });
	}
